...
class BoundingBox:
    ...
    def draw(self, painter, phase: float = 0.0):
        """
    ...
    def get_resize_handle_at_point(self, x, y, handle_size=8):
        ...
        handles = {
            ...
            "ne": (
                self.x + self.w - handle_size // 2,
                self.y - handle_size // 2,
                handle_size,
                handle_size,
            ),
            "sw": (
                self.x - handle_size // 2,
                self.y + self.h - handle_size // 2,
                handle_size,
                handle_size,
            ),
            "se": (
